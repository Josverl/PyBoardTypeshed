...
from _mpy_shed import PathLike  # type_ignore
...
# _OpenFile=TypeVar( "_OpenFile",StrOrBytesPath , int)
...
_Self = TypeVar("_Self")  # The type that extends `IOBase`.
...
class FileIO(IOBase):  # IOBase[bytes, "FileIO"]
    """
